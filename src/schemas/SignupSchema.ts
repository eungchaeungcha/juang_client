...
export const SignupErrorMessage = {
  ...
  usernameDuplicateChecked: "아이디 중복 확인이 필요합니다.",
  usernameDuplicated: "사용 불가능한 아이디입니다.",
...
export const SignupSchema = z
  .object({
    ...
    usernameDuplicated: z
      .boolean({ required_error: SignupErrorMessage.usernameDuplicateChecked })
      .refine((value) => value === false, {
        message: SignupErrorMessage.usernameDuplicated,
      }),
